...
- Wire Google Places, affiliate ids, and email capture once those decisions/credentials exist (all three are pure config — no code changes needed, components are already gated on env vars).
